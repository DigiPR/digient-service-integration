...
package rocks.process.integration.order.controller;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.ResponseEntity;
import org.springframework.stereotype.Controller;
import org.springframework.web.bind.annotation.GetMapping;
import rocks.process.integration.order.process.client.CheckoutAdapter;
...
public class CheckoutController {
    ...
    public ResponseEntity<String> getCheckout(){
        ...
        OrderMessage orderMessage = new OrderMessage(UUID.randomUUID().toString(), "1", 2000D, 15, orderItems, null, null, null, "OrderPlaced");
